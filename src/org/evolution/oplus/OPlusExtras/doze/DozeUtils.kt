...
object DozeUtils {
    ...
    fun checkDozeService(context: Context) {
        val isSupported = context.resources.getBoolean(R.bool.config_deviceSupportsAmbientDisplayGestures)
        if (isSupported && isDozeEnabled(context) && !isAlwaysOnEnabled(context) && areGesturesEnabled(context)) {
